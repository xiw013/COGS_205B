...
class TestBayesFactor(unittest.TestCase):
    ...
    def test_evidence_spike_normal(self):
        ...
        self.assertAlmostEqual(result, 0.3106)

    def test_evidence_spike_edge(self):
        # testing for k = 0
        l1 = BayesFactor(10, 0)
        result1 = l1.evidence_spike()
        self.assertAlmostEqual(result1, 0.001025)

        # testing for n = k
        l2 = BayesFactor(10, 10)
        result2 = l2.evidence_spike()
        self.assertAlmostEqual(result2, 0.001025)
